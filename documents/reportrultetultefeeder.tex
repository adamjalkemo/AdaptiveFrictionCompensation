...
%Since we observed that the friction is different depending on the sign of the arm velocity in \ref{fig:fric} we added a constant offset to our regressormodels, the coloumb+viscouse friction regressors with and without offset can seen in \ref{eq:regressorb}  and \ref{eq:regressorbo} respectively. $ $This resulted in an improved limit cycle behavior and marginally better step responses$ $. 
