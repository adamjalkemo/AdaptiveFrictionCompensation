...
\section{GUI}
The operator is able to change controller parameters for both controllers and for the friction estimator.

For the top controller, the $Q$ and $R$ matrices. For the swing up controller, the "switching area", natural frequency and gain. Other general parameters for the controller such as sampling time $h$ and deadzones.
