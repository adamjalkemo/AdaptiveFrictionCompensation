...
\end{figure}
\subsection{Friction estimation}
In fig. \ref{subfigure:VLUFcol} and \ref{subfigure:VLUFvisc} the calculated fricion and the calculated compensation signal is presented for both the coloumb and the coloumb and viscouse friction models.
\begin{figure}[H]
\centering
	\begin{subfigure}[t]{0.49\textwidth}
