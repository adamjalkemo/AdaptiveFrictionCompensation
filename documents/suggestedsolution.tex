...
In the top position a LQG controller will be used. To do this we will linearize the model in \ref{eq:model} around the top position with zero velocity for both the arm and the pendulum. The controllers will be implemented in Java.
